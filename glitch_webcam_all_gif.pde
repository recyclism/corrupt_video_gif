...
void draw() {
  ...
  strokeWeight(1);
    ...
    photo = loadImage("partialSave.gif");
    rect(0, 0, width, height);
   
   PImage partialSave = get(0, 0, width, height);
   partialSave.save("partialSave.gif");
  
 
   byte b[] = loadBytes("partialSave.gif");
   ...
   // glitch faces
     ...
     int nbOfReplacements = int (random(1, 100));
    ...
    saveBytes("partialSave.gif", bCopy);
     }
